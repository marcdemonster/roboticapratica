...
using namespace std;
    ...
    void pilha::inserir(TipoItem item)//push inserir itens
    {
        if(estacheia()){
    ...
    TipoItem pilha::remover()//Remover ou pop
    {
        if(estavazia()){
            cout << "A pilha esta vazia!\n"; //se quiser pode usar o throw
    ...
    int pilha::qualtamanho()//Qual o tamnho lenght
    {
        return tamanho;
    }